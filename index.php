...
<body>
  <!-- Navigation -->
  <header>
    <div class="logo"><span>RAPID</span>
      <nav class="navlinks">
        <a href="#">TAB1</a>
        <a href="#">TAB1</a>
        <a href="#">TAB1</a>
    ...
    <div class="auth-buttons">
      ...
      <button class="donate-btn" id="requestdonation">REQUEST DONATION</button>
    </div>
  </header>
  ...
  <div class="popup">
    ...
    <!-- Request Donation Content -->
    <div class="popup-content">
      <div class="popup-content-div">
        <img src="images/10886301.png" alt="">
      </div>
      ...
      <div class="popup-content-div color">
        ...
        <form class="popup-form" action="php/requestdonation.php" method="POST">
          ...
          <input list="districts_list" id="district_autocomplete" name="district" required
      ...
      <div class="popup-content-div color">
        ...
        <div class="popup-form">
          ...
          <br>
          <label for="email">Priority Message:</label><textarea rows="6" name="message" id="message"
            placeholder="Type your message" class="formbold-form-input-textarea"></textarea>

          <!--button group-->
          <div style="display: flex; justify-content: space-between; margin-top: 20px; gap: 10px;">
            <button class="donate-submit prev" style="width: 50%;">
              <svg fill="none" viewBox="0 0 24 24" class="arrow"
                style="width: 1em; height: 1em; vertical-align: middle; margin-left: 0.5em;">
                <path stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="currentColor"
                  d="M19 12H5M11 6l-6 6 6 6"></path>
              </svg>
              Previous
            </button>
  ...
  <section class="donate-section">
    ...
    <div class="slider">
      <div class="slideshow-container">
        ...
        <div class="mySlides fade">
          ...
          <img src="https://c0.wallpaperflare.com/preview/357/982/474/egypt-cairo-tower-cairo-sunset.jpg">
          <div class="text">
            <h1>Abraca Debra</h1>
            <p>A flood is an overflow of water (or rarely other fluids) that submerges land that is usually dry.[1] In
              the sense of "flowing water", the word may also be applied to the inflow of the tide. Floods are of
              significant concern in agriculture, civil engineering and public health. Human changes to the
              environment
              often increase the intensity and frequency of flooding. Examples for human changes are land use changes
              such as deforestation and removal of wetlands, changes in waterway course or flood controls such as with
              levees. Global environmental issues also influence causes of floods, namely climate change which causes
              an
              intensification of the water cycle and sea level rise.[2]: 1517  For example, climate change makes
              extreme
              weather events more frequent and stronger.</p>
            <button class="gradient-button">
              <span class="gradient-button-inner">learn More</span>
            </button>
          </div>
        </div>
        ...
        <div class="mySlides fade">
          ...
          <img
            src="https://c4.wallpaperflare.com/wallpaper/125/887/712/historic-mosque-madrassa-of-sultan-hassan-city-mosque-wallpaper-preview.jpg">
          <div class="text">
            <h1>Flood</h1>
            <p>A flood is an overflow of water (or rarely other fluids) that submerges land that is usually dry.[1] In
              the sense of "flowing water", the word may also be applied to the inflow of the tide. Floods are of
        ...
        <div class="mySlides fade">
          ...
          <img src="https://c1.wallpaperflare.com/preview/1019/166/561/stanley-bridge-alexandria-landmark-egypt.jpg">
          <div class="text">
            <h1>Flood</h1>
            <p>A flood is an overflow of water (or rarely other fluids) that submerges land that is usually dry.[1] In
              the sense of "flowing water", the word may also be applied to the inflow of the tide. Floods are of
    ...
    <div class="donate-content">
      ...
      <h2>DONATE NOW</h2>
      <p>Your contribution helps us support those in need.Your donation supports our mission.<br>Choose an amount to
        donate:</p>
      ...
      <form class="form-box">
        ...
        <button class="donate-submit">Donate and Support</button>
      </form>
    </div>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <h1>We are dedicated to helping those in need. Your support can change lives.</h1>
  ...
  <section class="hero white">
    <div class="hero-content">
      <h1>Together, we can make a bigger impact</h1>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
        ...
        versions
        of Lorem Ipsu</p>
      <button class="donate-submit">Get Involved</button>
    </div>
  </section>
  ...
  <section class="graph">
    <div class="graph-content">
      <div class="graph-card">
        <h2>Our Impact</h2>
        <p>We have made a significant impact in the community through our various initiatives and programs. Here are
          some of our key achievements:</p>
        <ul>
          <li>Over 10,000 meals distributed to those in need.</li>
          <li>500 families supported with essential supplies.</li>
          <li>1000 volunteers mobilized for community service.</li>
        </ul>
      </div>
      <div class="graph-card">
        <h2>Donation Trends</h2>
        <p>Track our donation trends over the past year to see how your contributions are making a difference.</p>
      </div>
      <button class="donate-submit">Learn More</button>
    </div>
    <!-- Graph Section -->
    <div class="card-container">
      <div class="card-header">
        <div>
          <h5 class="amount">$12,423</h5>
          <p class="subtitle">Donations of this week</p>
        </div>
        <div class="percentage-change">
          23%
          <svg class="arrow-up" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 14">
      ...
      <div class="card-footer">
        <div class="footer-controls">
          <button id="dropdownDefaultButton" class="dropdown-btn" type="button">
            Last 7 days
            <svg class="dropdown-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="m1 1 4 4 4-4" />
            </svg>
          </button>
          <div id="lastDaysdropdown" class="dropdown-menu">
            <ul>
          ...
          <a href="#" class="sales-report-link">
            Donation Report
            <svg class="link-arrow" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="m1 9 4-4-4-4" />
            </svg>
          </a>
  ...
  <section class="event-section">
    ...
    <p>Join us in our upcoming events to make a difference in the community.</p>
    <div class="event-buttons">
      <div class="container-btn">
        <div class="btn"><a href="#">Upcoming</a></div>
        <div class="btn"><a href="#">Ongoning</a></div>
    ...
    <div class="scroll-container">
      <div class="event-card">
        ...
        <p>Easter bunnies are a popular symbol of spring and renewal of life, often seen delivering colorful eggs to
          children.</p>
        <button class="gradient-button">
          <span class="gradient-button-inner">learn More</span>
        </button>
      ...
      <div class="event-card">
        <img
          ...
          alt="Easter Chick">
        <h2>Easter Chick</h2>
        <p>Easter chicks are a cheerful symbol of new life and beginnings, often seen alongside eggs in spring
          decorations.</p>
        <button class="gradient-button">
          <span class="gradient-button-inner">learn More</span>
        </button>
      ...
      <div class="event-card">
        ...
        <p>Hot cross buns are sweet, spiced buns marked with a cross on top, traditionally eaten on Good Friday.</p>
        <button class="gradient-button">
          <span class="gradient-button-inner">learn More</span>
        </button>
      </div>
      <div class="event-card">
        <img
          ...
          alt="Easter Eggs">
        <h2>Easter Eggs</h2>
        <p>Easter eggs are a colorful symbol of new life and rebirth, often decorated and hidden for festive hunts.
        </p>
        <button class="gradient-button">
          <span class="gradient-button-inner">learn More</span>
        </button>
  ...
  <!-- Event Section imgage -->
  <section class="event-section">
    <div class="container-img">
      <div class="info-box">
        <p>In India, at least 48 people have died since June 14, after heavy rains battered the northeastern state of
          Assam, according to its disaster management authority, triggering landslides and causing river banks to
          swell.
          More than 3.5 million people have been affected.</p>
      </div>
      <div class="image">
        <img src="https://c0.wallpaperflare.com/preview/357/982/474/egypt-cairo-tower-cairo-sunset.jpg"
          alt="Flood Image">
      ...
      <div class="info-box right">
        <p>In India, at least 48 people have died since June 14, after heavy rains battered the northeastern state of
          Assam, according to its disaster management authority, triggering landslides and causing river banks to
          swell.
          More than 3.5 million people have been affected in the state alone, the authority added.</p>
      </div>
    </div>
  </section>
  ...
  <section class="hero">
    <div class="hero-content">
      ...
      <p>We are proud to share our achievements and the impact we have made in the community.</p>
      <div class="marker">
        <div class="marker-item">
          <h1>5000+</h1>
          <h2>Volunteers</h2>
          <p>n India, at least 48 people have died since June 14, after heavy rains battered the northeastern state of
            Assam, according to its disaster management authority, triggering landslides and causing river banks to
            swell. More than 5.5 million people have been affected in the state alone</p>
        </div>
        <div class="marker-item">
          <h1>10000+</h1>
  ...
  <section class="hero">
    <article class="leaderboard">
      <header>
        <img src="https://cdn-icons-png.flaticon.com/512/684/684908.png" alt="Map Marker"
          style="width:40px;height:40px; transform: translateX(50%);">
        <h1 class="leaderboard__title"><span class="leaderboard__title--top">Request</span><span
            class="leaderboard__title--bottom">Leaderboard</span></h1>
      </header>

      <main class="leaderboard__profiles">
        <article class="leaderboard__profile">
          <span class="leaderboard__name">Rangpur</span>
          <span class="leaderboard__value">35</span>
        </article>

        <article class="leaderboard__profile">
          <span class="leaderboard__name">Dhaka</span>
          <span class="leaderboard__value">19</span>
        </article>

        <article class="leaderboard__profile">
          <span class="leaderboard__name">Barishal</span>
  ...
  <section class="hero">
    <div class="hero-content">
      <h1>Feedback</h1>
      <p>We value your feedback and suggestions.<br> Please let us know how we can improve our services.</p>
      <button class="super-button">
      ...
      <div class="formbold-form-wrapper">
        <form action="https://formbold.com/s/FORM_ID" method="POST">
          ...
          <div class="formbold-input-radio-wrapper">
            <label for="jobtitle" class="formbold-form-label"> Giving feedback as ? </label>
